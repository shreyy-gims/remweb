...
const gamePhotos = [
  {
    id: 1,
    photo: "/placeholder.svg?height=400&width=400&text=Childhood+Photo+1",
    options: ["Alex Johnson", "Emma Wilson", "Michael Chen", "Sophia Martinez"],
    correctAnswer: 0,
    difficulty: "easy",
    points: 100,
    hint: "This person was the class president in 10th grade",
    photoType: "childhood",
  },
  {
    id: 2,
    photo: "/placeholder.svg?height=400&width=400&text=Baby+Photo+1",
    options: ["Sarah Davis", "James Miller", "Olivia Brown", "Noah Garcia"],
    correctAnswer: 1,
    difficulty: "hard",
    points: 200,
    hint: "Known for their amazing basketball skills",
    photoType: "baby",
  },
  {
    id: 3,
    photo: "/placeholder.svg?height=400&width=400&text=Funny+Photo+1",
    options: ["Mrs. Seema Philips", "Dr. Jaya Ghosh", "Mr. T.K Sahu", "Mr. C.P Sharma"],
    correctAnswer: 2,
    difficulty: "medium",
    points: 150,
    hint: "This teacher always says 'Mathematics is beautiful'",
    photoType: "funny",
  },
  {
    id: 4,
    photo: "/placeholder.svg?height=400&width=400&text=School+Event+Photo",
    options: ["Ethan Taylor", "Mia Johnson", "Lucas Martinez", "Isabella Jones"],
    correctAnswer: 0,
    difficulty: "easy",
    points: 100,
    hint: "Won the science fair last year",
    photoType: "event",
  },
  {
    id: 5,
    photo: "/placeholder.svg?height=400&width=400&text=Graduation+Photo",
    options: ["Principal Sumita", "Vice Principal", "Dean of Studies", "Head of Academics"],
    correctAnswer: 0,
    difficulty: "medium",
    points: 150,
  ...
  {
    id: 6,
    photo: "/placeholder.svg?height=400&width=400&text=Sports+Photo",
    options: ["David Wilson", "Amy Chen", "Ryan Patel", "Lisa Kumar"],
    correctAnswer: 2,
    difficulty: "hard",
    points: 200,
    hint: "Captain of the cricket team",
    photoType: "sports",
  },
  {
    id: 7,
    photo: "/placeholder.svg?height=400&width=400&text=Childhood+Photo+2",
    options: ["Maya Singh", "Arjun Sharma", "Priya Gupta", "Rohit Verma"],
    correctAnswer: 1,
    difficulty: "medium",
    points: 150,
  ...
  {
    id: 8,
    photo: "/placeholder.svg?height=400&width=400&text=Teacher+Young+Photo",
    options: ["Young Mr. Sahu", "Young Mrs. Philips", "Young Dr. Ghosh", "Young Mr. Sharma"],
    correctAnswer: 1,
    difficulty: "hard",
    points: 200,
    hint: "Geography teacher who loves traveling",
    photoType: "teacher-young",
  },
]
