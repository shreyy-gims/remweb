...
const gamePhotos = [
  ...
  },
  {
    ...
    difficulty: "medium",
    points: 150,
    hint: "Has been leading our school for 3 years",
    photoType: "formal",
  },
  {
    id: 6,
    photo: "/khobragade.jpeg",
    options: ["Rajesh Bhaiya", "Kamal Bhaiya", "Raju Bhaiya", "Santosh Bhaiya"],
    correctAnswer: 2,
    difficulty: "hard",
    points: 200,
    hint: "Guard bhaiya",
  ...
  {
    id: 7,
    photo: "/guesswho2.jpeg",
    options: ["Purva", "Akshita", "Gauri ", "Jennifer"],
    correctAnswer: 2,
    difficulty: "medium",
    points: 150,
  ...
  },
  {
    id: 8,
    photo: "/akshya.jpeg",
    options: ["Soumya", "Kirti", "akshaya", "ayushi"],
    correctAnswer: 2,
    difficulty: "hard",
    points: 200,
