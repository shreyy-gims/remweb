...
const quizQuestions = [
  {
    ...
    question: "Who is the current principal of our school?",
    options: ["Dr. Sumita Sarkar", "Mrs. Priya Sharma", "Mr. Rajesh Kumar", "Dr. Anita Gupta"],
    correctAnswer: 0,
    difficulty: "easy",
    points: 10,
  ...
  },
  {
    id: 3,
    type: "true-false",
    question: "Our school has won the inter-school basketball championship for 3 consecutive years.",
    options: ["1985", "1990", "1995", "2000"],
    correctAnswer: 2,
    difficulty: "easy",
    points: 10,
  ...
  },
  {
    id: 7,
    type: "multiple-choice",
    question: "What is the name of our school's annual cultural festival?",
    options: ["Kaleidoscope", "Spectrum", "Vibrance", "Euphoria"],
    correctAnswer: 2,
    difficulty: "easy",
    points: 10,
    category: "Events",
